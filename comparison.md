...
| Metric | YOLOv8 (50 Epochs) | YOLOv8 (30 Epochs) | YOLOv5 (30 Epochs) | YOLOv10 (30 Epochs) | RT-DETR (5 Epochs) | YOLO11 (Initial Test) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **mAP@50** | **56.1%** | 54.9% | 53.3% | 48.9% | 44.6% | 54.1% |
| **Precision** | 58.0% | 58.5% | **59.9%** | 55.1% | 50.4% | 57.5% |
| **Recall** | **53.6%** | 51.8% | 48.1% | 45.8% | 45.7% | 50.5% |
| **mAP@50-95** | **32.0%** | 31.1% | 30.0% | 27.7% | 23.8% | 30.8% |
...
*   **YOLOv10**: Performed worse than v8 (49% mAP) on this dataset, despite being a newer architecture.
